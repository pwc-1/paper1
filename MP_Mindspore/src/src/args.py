...
def parse_arguments():
    ...
    parser.add_argument("--file_format", type=str, choices=["AIR", "MINDIR", "ONNX"], default="MINDIR",
                        help="file format")
    parser.add_argument("--tuning_mode", type=str, choices=["psrp", "linear_probe", "full_finetune"], default="linear_probe",
                        help="tuning mode")
    ...
    parser.add_argument("--lr_adjust", default=3, type=float, help="Interval to drop lr")
