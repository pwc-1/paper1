...
parser.add_argument('--checkpoints', default='/home/jingxuan/skipplan/ckpt',
    ...
    for i, (_, _, frames, _, lowlevel_labels, _) in enumerate(trainset):
        ...
        if i % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                ...
                .format(
                epoch, i, len(trainset), batch_time=batch_time,
    ...
    for i, (_, _, frames, _, lowlevel_labels, _) in enumerate(testset):
        ...
        if i % args.print_freq == 0 or i + 1 == len(testset):
            print('Test: [{0}/{1}]\t'
                ...
                .format(
                i, len(testset), batch_time=batch_time, loss=losses,
