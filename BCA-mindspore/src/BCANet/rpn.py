...
class RPN(nn.Cell):
    ...
    def __init__(self,
        ...
        self.num_layers = 5
        self.real_ratio = ms.Tensor(np.ones((1, 1), self.dtype))
        ...
        self.fill = ops.Fill()
        self.placeh1 = ms.Tensor(np.ones((1,), self.dtype))
        ...
        self.loss = ms.Tensor(np.zeros((1,), self.dtype))
        self.clsloss = ms.Tensor(np.zeros((1,), self.dtype))
        self.regloss = ms.Tensor(np.zeros((1,), self.dtype))
