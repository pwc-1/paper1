...
class ResidualBlock(nn.Cell):   # Bottleneck
    """
...
class ResidualBlockBase(nn.Cell):   # BasicBlock
    """
    ResNet V1 residual block definition.
...
def build_resnetv1_backbone(depth, num_classes):
    if depth == 18:
