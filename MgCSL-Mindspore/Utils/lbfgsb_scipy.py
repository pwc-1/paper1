...
class LBFGSBScipy(nn.Optimizer):
    ...
    def __init__(self, params, learning_rate):
        super(LBFGSBScipy, self).__init__(learning_rate=learning_rate, parameters=params)
    ...
    def _gather_flat_grad(self):
        ...
        for p in self.parameters:
            view = Tensor(shape=p.size, dtype=ms.float64, init=init.One())
            views.append(view)
    ...
    def _distribute_flat_params(self, params):
        ...
        for p in self.parameters:
            ...
            p = params[offset:offset + numel].view_as(p.data)
            offset += numel
    ...
    def step(self, closure):
        ...
        def wrapped_closure(flat_params):
            ...
            flat_params = flat_params.to(ms.float64)
        ...
        final_params = Tensor(sol.x)
        final_params = final_params.to(ms.float64)
