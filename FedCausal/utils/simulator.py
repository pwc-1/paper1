...
class DAG(object):
    ...
    @staticmethod
    def erdos_renyi_2(n_nodes, n_edges, weight_range=None, seed=None, num_clients=10):
        ...
        if weight_range is None:
            ...
            W = DAG._BtoW_2(B, n_nodes, weight_range, num_clients)
        return B, W

    @staticmethod
    def scale_free_2(n_nodes, n_edges, weight_range=None, seed=None, num_clients=10):
